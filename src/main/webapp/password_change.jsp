...
<head>
    ...
    <link href="css/form.css" rel="stylesheet"> <!-- 외부 스타일시트 적용 -->
    ...
    <div class="profile-container">
        ...
        <form action="updatePassword" method="post" onsubmit="return validatePasswords();">
            <div class="form-group">
                ...
                <input type="password" id="password" name="password" minlength="8" maxlength="20" placeholder="새 비밀번호를 8~20자 내로 입력해주세요." required>
            </div>

            <div class="form-group">
                <label for="confirmPassword">새 비밀번호 확인</label>
                <input type="password" id="confirmPassword" name="confirmPassword" minlength="8" maxlength="20" placeholder="새 비밀번호를 다시 입력해주세요." required>
            </div>
